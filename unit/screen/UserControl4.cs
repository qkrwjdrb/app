...
namespace unit.screen
{
    public partial class UserControl4 : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Length를 입력해주세요.", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
